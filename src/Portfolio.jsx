  ...
  return (
    <div style={{ 
      ...
      <nav style={{
        ...
        background: navScrolled ? (isFool ? "rgba(5,3,12,0.6)" : "rgba(11,15,25,0.6)") : "transparent",
      ...
      <section style={{ position: "relative", minHeight: "100vh", display: "flex", alignItems: "center", paddingTop: 80, paddingBottom: 80 }}>
        ...
        <div className="hero-grid" style={{
          ...
          <motion.div
            ...
            style={{
              width: "100%", maxWidth: 460, aspectRatio: "4/5", margin: "0 auto",
          ...
          <div>
            ...
            <motion.p
              ...
              style={{
                fontFamily: bodyFont, fontSize: "clamp(1.05rem, 1.5vw, 1.25rem)",
      ...
      {/* ══ ABOUT ME ════════════════════════════════════════════════ */}
      <section id="about" style={{ padding: "8rem 4rem", background: bg2, borderTop: `1px solid ${border}` }}>
        <div style={{ maxWidth: 1000, margin: "0 auto" }}>
          ...
          <div className="about-grid" style={{ display: "grid", gridTemplateColumns: "1fr 300px", gap: "4rem", marginTop: "3rem", alignItems: "center" }}>
            <Reveal delay={0.1}>
              <p style={{ fontFamily: bodyFont, fontSize: "1.15rem", lineHeight: 1.8, color: textSecondary, marginBottom: "1.5rem" }}>
                {isFool 
              ...
              <p style={{ fontFamily: bodyFont, fontSize: "1.15rem", lineHeight: 1.8, color: textSecondary, whiteSpace: "pre-line" }}>
                {isFool 
      ...
      {/* ══ PROJECTS ══════════════════════════════════════════════ */}
      <section id="projects" style={{ padding: "8rem 4rem", maxWidth: 1280, margin: "0 auto", overflowX: "hidden" }}>
        <Reveal>
        ...
        {!isFool && (
          <Reveal delay={0.1}>
            <div style={{ position: "relative", width: "100%", overflow: "hidden", marginTop: "2rem", marginBottom: "4rem" }}>
              {/* Fade edges */}
              ...
              >
                {[...PROJECTS, ...PROJECTS, ...PROJECTS, ...PROJECTS].map((p, i) => (
                  <a key={i} href={p.viewLink || "#"} style={{
                    padding: "16px 32px", borderRadius: 40, border: `1px solid ${border}`,
                    background: "rgba(255,255,255,0.02)", color: textSecondary, textDecoration: "none",
                    fontFamily: headingFont, fontSize: "1.2rem", fontWeight: 600, whiteSpace: "nowrap",
        ...
        <div style={{ display: "grid", gridTemplateColumns: "repeat(auto-fill, minmax(400px, 1fr))", gap: "2.5rem", marginTop: isFool ? "4rem" : "1rem" }}>
          {PROJECTS.map((p, i) => (
            <Reveal key={p.title} delay={i * 0.1}>
              <ProjectCard project={p} accent={accent} highlight={highlight} bg2={bg2} border={border} textMuted={textMuted} textSecondary={textSecondary} textPrimary={textPrimary} headingFont={headingFont} bodyFont={bodyFont} />
            </Reveal>
          ))}
        </div>
      </section>
      ...
      <section id="skills" style={{ background: bg2, borderTop: `1px solid ${border}`, borderBottom: `1px solid ${border}` }}>
        <div style={{ padding: "8rem 4rem", maxWidth: 1280, margin: "0 auto" }}>
          <Reveal>
          ...
          <div style={{ display: "grid", gridTemplateColumns: "repeat(auto-fit, minmax(260px, 1fr))", gap: "2rem", marginTop: "4rem" }}>
            {currentSkills.map((grp, gi) => (
              <Reveal key={grp.label} delay={gi * 0.1}>
                <SkillGroup group={grp} accent={accent} border={border} textSecondary={textSecondary} textPrimary={textPrimary} bg={bg} bodyFont={bodyFont} />
              </Reveal>
            ))}
          </div>
        </div>
      ...
      {/* ══ CONTACT ════════════════════════════════════════════ */}
      <section id="contact" style={{ padding: "10rem 4rem", textAlign: "center" }}>
        <Reveal>
        ...
        <Reveal delay={0.1}>
          <p style={{ fontFamily: bodyFont, fontSize: "1.2rem", color: textSecondary, marginBottom: "3rem", maxWidth: 500, margin: "0 auto 3rem", lineHeight: 1.6 }}>
            {isFool 
        ...
        <Reveal delay={0.2}>
          <a href="mailto:deepakgariya987@gmail.com" style={{
            fontFamily: headingFont, fontSize: "1.5rem", fontWeight: 600, 
          ...
          <div style={{ display: "flex", gap: "1.5rem", justifyContent: "center", marginTop: "4rem", flexWrap: "wrap" }}>
            {[
              ...
              <a key={label} href={href} target="_blank" rel="noreferrer" style={{
                ...
                color: textSecondary, textDecoration: "none", padding: "12px 28px",
      ...
      <footer style={{
        ...
        padding: "3rem 4rem", background: bg2,
        fontFamily: bodyFont, fontSize: 12, letterSpacing: "0.05em", color: textMuted,
        flexWrap: "wrap", gap: "1rem", borderTop: `1px solid ${border}`
      }}>
...
function ProjectCard({ project, accent, highlight, bg2, border, textMuted, textSecondary, textPrimary, headingFont, bodyFont }) {
  const [hv, setHv] = useState(false);
  return (
    ...
    >
      ...
      <h3 style={{
        fontFamily: headingFont, fontWeight: 600, fontSize: "1.6rem",
        color: textPrimary, marginBottom: "1rem", transition: "color 0.4s",
      }}>{project.title}</h3>

      <p style={{ 
        fontFamily: bodyFont, fontSize: "1.1rem", color: textSecondary, 
      ...
      <div style={{ display: "flex", gap: "1.5rem", alignItems: "center", marginTop: "2rem" }}>
        <a href={project.viewLink || "#"} style={{
           fontFamily: "'Inter', sans-serif", fontSize: 12, fontWeight: 700, letterSpacing: "0.1em", textTransform: "uppercase",
        ...
        <a href={project.link} target="_blank" rel="noreferrer" style={{
           fontFamily: "'Inter', sans-serif", fontSize: 12, fontWeight: 600, letterSpacing: "0.1em", textTransform: "uppercase",
...
function SkillGroup({ group, accent, border, textSecondary, textPrimary, bg, bodyFont }) {
  const [hv, setHv] = useState(false);
  return (
    <div 
      ...
      <div style={{ display: "flex", flexDirection: "column", gap: "1rem" }}>
        {group.items.map(skill => (
          <div key={skill} style={{ display: "flex", alignItems: "center", gap: "1rem" }}>
            ...
            <span style={{ fontFamily: bodyFont, fontSize: "1.1rem", color: textSecondary }}>
              {skill}
            </span>
          </div>
        ))}
  ...
  return `
    ...
    *, *::before, *::after { margin:0; padding:0; box-sizing:border-box; }
    ...
    @media (max-width:960px) {
      ...
      .hero-photo-wrap { max-width:280px !important; margin:0 auto !important; }
    }
  `;
}
